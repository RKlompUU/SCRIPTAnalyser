...
Scripts can be specified in an extended language. Visit https://vm100.cs.stir.ac.uk/%7Erkl/docu.php, or https://github.com/RKlompUU/SCRIPTWriter, for a description of allowed syntax in this extended language.
